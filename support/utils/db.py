...
#from dbase_methods.db_favorites import ClassFavoritesCql
...
from dbase_methods.db_warehouse_index import ClassElasticsearchQuery
from dbase_methods.db_warehouse_psql import ClassWarehouseSql
#from dbase_methods.db_warehouse_sms import ClassCassandraSmsCql
from support import service_log, configs
#from support.utils.db_cassandra import ClassCassandraDriver
from support.utils.db_elasticsearch import ClassElasticsearchConnections
...
class ClassDatabasesWork():
    ...
    sv = {"pgsql": {"accounting": [ClassAccountingSql, ClassPsyCopg2],
                    "warehouse": [ClassWarehouseSql, ClassPsyCopg2]},
          ...
          "cassandra": {
              ...
              #"warehouse_sms": [ClassCassandraSmsCql, ClassCassandraDriver],
              #"favorites": [ClassFavoritesCql, ClassCassandraDriver]
          },
          "elasticsearch": {"warehouse": [ClassElasticsearchQuery, ClassElasticsearchConnections]}
          }
